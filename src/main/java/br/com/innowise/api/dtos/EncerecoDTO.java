...
import br.com.innowise.api.documents.Encereco;

public class EncerecoDTO {
	private String cep;
	...
	public EncerecoDTO(String cep, String numero, String rua, String bairro, String cidade, String estado,
			String pais) {
		super();
		this.cep = cep;
		this.numero = numero;
	...
	public EncerecoDTO(Encereco encereco) {
		super();
